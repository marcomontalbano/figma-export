...
import type { Style, StyleOutputter } from './styles/index.js';
...
export type ComponentsCommand = (
  options: BaseCommandOptions & ComponentsCommandOptions,
) => Promise<PageNode[]>;

export type StylesCommand = (
  options: BaseCommandOptions & StylesCommandOptions,
) => Promise<Style[]>;
