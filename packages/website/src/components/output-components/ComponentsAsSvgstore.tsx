...
const ComponentsAsSvgstore = () => (
  <div className="section-block container text-center">
    <h3>
      <code className="figma-gradient with-opacity-10">SVG Sprites</code>
    </h3>
    <div>
      ...
      are, basically you can combine multiple images into a single image file
      and use it on a website. SVG Sprites are very similar, but you will use
      .svg instead of .png. Discover more on this article &quot;
      <a
        target="_blank"
        rel="noopener noreferrer"
