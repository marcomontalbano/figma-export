  ...
  <div className="section-block container text-center">
    <div>
      ...
      <div className="feature-box">
        ...
        <div
          className="figma-box color-1-lighter"
          data-tooltip="color-1-lighter"
        />
      ...
      <div className="feature-box">
        ...
        <div
          className="figma-box color-alpha-50"
          data-tooltip="color-alpha-50"
        />
        <div
          className="figma-box color-figma-gradient"
          data-tooltip="color-figma-gradient"
        />
        <div
          className="figma-box color-linear-gradient"
          data-tooltip="color-linear-gradient"
        />
        <div
          className="figma-box color-linear-gradient-alpha"
          data-tooltip="color-linear-gradient-alpha"
        />
        <div
          className="figma-box color-multi-gradient"
          data-tooltip="color-multi-gradient"
        />
      </div>
      <div className="feature-box">
        ...
        <div
          className="figma-box inner-shadow-bottom"
          data-tooltip="inner-shadow-bottom"
        />
      ...
      <div className="feature-box">
        ...
        <div className="figma-box with-content">
          <div className="h1" data-tooltip="h1">
            Sample text
          </div>
          <div className="h2" data-tooltip="h2">
            Sample text
          </div>
          <div className="regular-text" data-tooltip="regular-text">
            Sample text
          </div>
          <div className="deleted-text" data-tooltip="deleted-text">
            Sample text
          </div>
        </div>
      </div>
