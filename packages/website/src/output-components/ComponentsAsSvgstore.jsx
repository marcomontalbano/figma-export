...
const ComponentsAsSvgstore = () => (
    <div className="section-block container text-center">
        <h3 id="svg-sprites"><code className="figma-gradient with-opacity-10">SVG Sprites</code></h3>
        <div>
            ...
            &quot;
            <a target="_blank" rel="noopener noreferrer" href="https://css-tricks.com/svg-sprites-use-better-icon-fonts/">
