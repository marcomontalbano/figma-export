...
describe('utils', () => {
  describe('writeVariable', () => {
    it('should return empty string is the value is empty', () => {
      const text = writeVariable('This is a comment', 'variable-name', '');

      expect(text).to.eql('');
    });

    it('should be able to print-out simple variable', () => {
      const text = writeVariable('This is a comment', 'variable-name', '#fff');
  ...
  describe('writeMap', () => {
    it('should return empty string is the value is empty', () => {
      const text = writeMap('This is a comment', 'variable-name', '');
