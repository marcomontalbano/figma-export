...
describe('export-styles', async () => {
    ...
    it('should use outputter to export styles without defining the "onlyFromPages" option', async () => {
        ...
        expect(client.fileNodes).toHaveBeenCalledWith('fileABCD', { ids: fileNodeIds, version: 'versionABCD' });
        expect(client.file).toHaveBeenCalledOnce;
        expect(client.file).toHaveBeenNthCalledWith(1, 'fileABCD', { version: 'versionABCD', depth: undefined, ids: undefined });
    ...
    it('should use outputter to export styles', async () => {
        ...
        expect(client.file).toHaveBeenNthCalledWith(2, 'fileABCD', { version: 'versionABCD', depth: undefined, ids: ['254:0'] });
    ...
    it('should use default "logger" if not defined', async () => {
        ...
        expect(console.log).toHaveBeenNthCalledWith(4, 'exported styles from fileABCD');
    });
